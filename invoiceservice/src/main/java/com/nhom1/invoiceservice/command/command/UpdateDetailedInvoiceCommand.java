...
@AllArgsConstructor
@NoArgsConstructor
public class UpdateDetailedInvoiceCommand {
	...
	public UpdateDetailedInvoiceCommand(String detailedInvoiceID, String invoiceID, String productID, int quantity, int price,
